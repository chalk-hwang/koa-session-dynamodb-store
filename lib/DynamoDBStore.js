...
export default class DynamoDBStore {
  ...
  setOptions(options: Object): void {
    const { table = {}, dynamoConfig = {} } = options;
    ...
    const {
      ...
      useDynamodbTtl = DEFAULT_USE_DYNAMODB_TTL,
    } = table;
    ...
    Object.assign(this, {
      ...
      isLocal: dynamoConfig.region === 'local',
      useDynamodbTtl,
    });
  }
  ...
  async get(id: string): Object {
    ...
    try {
      return await this.documentClient
        ...
        .promise()
        .then(result => result.Item.session);
    } catch (err) {
